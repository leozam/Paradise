				...
				<div class="left_content">
					...
					<c:forEach items="${obj.list }" var="normal">
						<div class="feat_prod_box">
							<div class="prod_img">
								<a href="${base }/getContent/media/detail?id=${normal.id}"
									target="_blank"><img
										src="${base}/getContent/media/getHeadPic?mediaId=${normal.id}"
					...
					<div class="pagination">
						<c:choose>
							...
							<c:otherwise>
								<a
									href="${base }/getContent/media/list?type=${type }&page=${obj.pager.pageNumber-1}"><<</a>
							</c:otherwise>
						</c:choose>
						...
						<c:forEach var="p" begin="1" end="${obj.pager.pageCount }">
							<c:choose>
								...
								<c:otherwise>
									<a
										href="${base }/getContent/media/list?type=${type }&page=${p}">${p
										}</a>
								</c:otherwise>
							</c:choose>
						</c:forEach>
