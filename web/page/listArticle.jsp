				...
				<div class="left_content">
					...
					<c:forEach items="${obj.list }" var="normal">
						<div class="feat_prod_box">
							<div class="prod_img">
								<a href="${base }/getContent/article/detail?id=${normal.id}"
									target="_blank"><img
										src="${base}/getContent/article/getHeadPic?articleId=${normal.id}"
							...
							<div class="prod_det_box">
								...
								<div class="box_center">
									<div class="prod_title"> 
										<a href="${base }/getContent/article/detail?id=${normal.id}" target="_blank"
										style="text-decoration: none">${fn:substring(normal.title,0,30) }</a>
									</div>
									<p class="details">
										${fn:substring(normal.remark,0,80) }
									</p>
					...
					<div class="pagination">
						<c:choose>
							...
							<c:otherwise>
								<a href="${base }/getContent/article/list?type=${type }&page=${obj.pager.pageNumber-1}"><<</a>
							</c:otherwise>
						</c:choose>
						...
						<c:forEach var="p" begin="1" end="${obj.pager.pageCount }">
							<c:choose>
								...
								<c:otherwise>
									<a
										href="${base }/getContent/article/list?type=${type }&page=${p}">${p
										}</a>
								</c:otherwise>
							</c:choose>
						</c:forEach>
